...
>
	...
	<div
		class="h-full w-full rounded-full"
		class:bg-stone-800="{value === 3 || value === 4 || value === 5 || value === 6}"
	></div>
	<div class="h-full w-full rounded-full" class:bg-stone-800="{value === 2 || value === 6}"></div>
	<div
		class="h-full w-full rounded-full"
		class:bg-stone-800="{value === 1 || value === 3 || value === 5}"
	></div>
	<div class="h-full w-full rounded-full" class:bg-stone-800="{value === 2 || value === 6}"></div>
	<div
		class="h-full w-full rounded-full"
